      ...
      <div className="flex h-full w-full relative">
        ...
        <aside className={`fixed md:relative z-50 h-full flex flex-col bg-[#f5f4f0] shrink-0 pt-4 transition-transform duration-300 shadow-2xl md:shadow-none ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} ${isSidebarCollapsed ? 'w-[200px] md:w-[72px]' : 'w-[200px]'}`}>
          ...
          <nav className={`flex-1 space-y-1 ${isSidebarCollapsed ? 'px-2' : 'pl-3'}`}>
            <Link
              href="/"
              className={`flex items-center gap-2 py-2 rounded-lg text-on-surface-variant hover:bg-zinc-200/50 hover:text-on-surface transition-all font-semibold ${isSidebarCollapsed ? 'justify-center w-10 h-10 p-0 mx-auto' : 'w-[calc(100%+16px)] pl-2 pr-4 text-left'
                }`}
            >
            ...
            <div
              className={`flex items-center gap-2 py-2 rounded-lg text-on-surface-variant cursor-pointer hover:bg-zinc-200/50 hover:text-on-surface transition-all font-semibold ${isSidebarCollapsed ? 'justify-center w-10 h-10 p-0 mx-auto' : 'w-[calc(100%+16px)] pl-2 pr-4 text-left'
                }`}
            >
          ...
          <div className={`py-4 mt-auto ${isSidebarCollapsed ? 'px-2' : 'pl-4 pr-1'}`}>
            ...
            <div className="space-y-1">
              {[
                ...
                <div
                  key={item.label}
                  className={`flex items-center gap-3 py-2 text-on-surface-variant rounded-lg font-semibold cursor-pointer hover:bg-zinc-200/50 hover:text-on-surface transition-all ${isSidebarCollapsed ? 'justify-center w-10 h-10 p-0 mx-auto' : 'w-[calc(100%+16px)] pl-2 pr-4 text-[13px] text-left whitespace-nowrap'
                    }`}
        ...
        <div className={`flex-1 h-full flex flex-col pt-20 md:pt-12 pb-2 px-2 md:pr-2 min-w-0 relative transition-all duration-300 ${isSidebarCollapsed ? 'md:pl-0' : 'md:pl-6'}`}>
          ...
          <header className="absolute top-0 right-0 left-0 h-14 md:h-12 flex justify-between md:justify-end items-center px-4 md:pl-10 md:pr-5 pointer-events-none z-30">
            ...
            <div className="flex items-center gap-4 md:gap-5 pointer-events-auto pt-4 md:pt-0">
              <div className="relative text-on-surface-variant flex items-center justify-center p-2 rounded-full cursor-pointer hover:bg-zinc-200/50 transition-colors">
